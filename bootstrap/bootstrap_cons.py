...
def main():
    ...
    attribution = LES(model=voting_clf, method="consensussecond_parallel")

    
    diff = one_bootstrap_diff(
        args.seed,
        attribution.consensussecond_parallel,
    ...
    out_dir = os.path.join(args.data_dir, "bootstrap_diffs_cons")
